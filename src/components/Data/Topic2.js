                        ...
                        <div class="row">
                            <div class="col-xl-6" >
                                <div className="img-container">
                                    {/* <img src="https://img.icons8.com/cotton/64/000000/mountain.png"  />  */}
                                    {/* <Indexbutton /> */}
                                </div>
                            </div>
                            <div class="col-xl-6" >
                                <div className="text"> 
                                    <p>เสือดาวเป็นเสือที่สามารถปรับตัวเข้ากับสภาพแวดล้อมได้ดีที่สุด เขตกระจายพันธุ์กว้างขวางที่สุด <br />
